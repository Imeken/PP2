...
background = pygame.image.load(r"C:\PP2\Lab 8\road.jpg")
DEFAULT_IMAGE_SIZE = (80, 150)
enemy_image = pygame.image.load(r"C:\PP2\Lab 8\enemy.png")
enemy = pygame.transform.scale(enemy_image, DEFAULT_IMAGE_SIZE)
player_image = pygame.image.load(r"C:\PP2\Lab 8\player.png")
player = pygame.transform.scale(player_image, DEFAULT_IMAGE_SIZE)
coin_image = pygame.image.load(r"C:\PP2\Lab 8\coin.png")
...
while True:
    ...
    if coin_collected:
        pygame.mixer.Sound(r"C:\PP2\Lab 8\coin_collect.mp3").play()
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound(r"C:\PP2\Lab 8\crash.wav").play()
        time.sleep(0.5)

        crashed_image = pygame.image.load(r"C:\PP2\Lab 8\Crashed_Mercedes-Benz_vehicles.jpg")
